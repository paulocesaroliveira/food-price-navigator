  ...
  useEffect(() => {
    if (existingConfig) {
      setFormData({
        ...
        labor_cost_type: (existingConfig.labor_cost_type as 'fixed' | 'percentage') || 'fixed',
        overhead_cost: existingConfig.overhead_cost || 0,
        overhead_cost_type: (existingConfig.overhead_cost_type as 'fixed' | 'percentage') || 'fixed',
        marketing_cost: existingConfig.marketing_cost || 0,
        marketing_cost_type: (existingConfig.marketing_cost_type as 'fixed' | 'percentage') || 'fixed',
        delivery_cost: existingConfig.delivery_cost || 0,
        delivery_cost_type: (existingConfig.delivery_cost_type as 'fixed' | 'percentage') || 'fixed',
        other_costs: existingConfig.other_costs || 0,
        other_cost_type: (existingConfig.other_cost_type as 'fixed' | 'percentage') || 'fixed',
