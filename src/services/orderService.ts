...
// Define type for order creation that matches what Supabase expects but omits order_number
type OrderForCreation = Omit<Order, "id" | "created_at" | "updated_at" | "order_number"> & {
  // order_number is required by Supabase types but will be generated by DB trigger
  order_number?: string;
};
...
export async function createOrder(
  ...
  try {
    // Insert the order
    // We need to submit the order without order_number even though it's in the type
