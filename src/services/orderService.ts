...
// Update the type to not expect order_number since it's generated by a database trigger
export async function createOrder(
  ...
  try {
    // Insert the order
    // We're not providing order_number as it's generated by the database trigger
